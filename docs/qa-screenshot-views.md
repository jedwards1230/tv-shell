...
| — | Web Apps — empty state vs populated list (#187) | substate — P0 lists registry entries from `SettingsStore.webApps` (daemon `webapp-list`, graceful-empty until P1); reachable via `intent settings:webapps` |
