...
FocusScope {
    ...
    onIpAddressChanged: {
        ...
        } else if (!root._wasConnected && connected && ipAddress !== "...") {
    ...
    Keys.onRightPressed: { if (currentIndex > 0) currentIndex-- }
    Keys.onLeftPressed: { if (currentIndex < _iconCount - 1) currentIndex++ }
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            Image {
                ...
                width: root._imgSize; height: root._imgSize
        ...
        Rectangle {
            ...
            Image {
                id: themeIcon; anchors.centerIn: parent
            ...
            MouseArea {
                id: themeMA; anchors.fill: parent; hoverEnabled: true
                cursorShape: Qt.PointingHandCursor
                onClicked: {
                    if (Theme.themeMode === "auto") Theme.setThemeMode("light")
                    else if (Theme.themeMode === "light") Theme.setThemeMode("dark")
        ...
        Rectangle {
            ...
            Image {
                id: netIcon; anchors.centerIn: parent
            ...
            MouseArea {
                id: networkMA; anchors.fill: parent; hoverEnabled: true
            }
        }
        ...
        Rectangle {
            ...
            Image {
                id: volIcon; anchors.centerIn: parent
            ...
            MouseArea {
                id: volumeMA; anchors.fill: parent; hoverEnabled: true
            }
        }
    }
}
