...
//! Refusing to build the compositor's control process because a version string
//! could not be computed would be the tail wagging the dog.
//!
//! `cec/build.rs` is a deliberate copy of this file. Sharing it would mean a
